                	...
                	<div class="r100 overflowauto content_section">
                    	...
                    	<div class="maxwidth overflowauto vpadding5">
                            ...
                            <div class="w90 rbg5 bge4e6e9 vpadding10px bmargin50px">
								...
								<h2 class="txtcntr h148sspr"><?php  _e('Search Results for : ', 'alexandria') ?><?php  echo get_search_query(); ?></h2>                            
                        	...
                        	<div class="w90 bpadding5p overflowauto <?php  post_class(); ?>"  id="post-<?php  the_ID(); ?>">
                                ...
                                <div class="r100">
													...
													<div class="metadata r100 brdbtm1E4E6E9 vpadding10px overflowauto">
														...
														<?php  the_tags('<p><span class="label">'.__('Tags:','alexandria').'</span><span class="text">', ', ', '</span></p>'); ?>
